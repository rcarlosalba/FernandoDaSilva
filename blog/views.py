...
def post_detail(request, slug):
    ...
    return render(request, 'dashboard/blog/post_detail.html', context)
...
def category_detail(request, slug):
    ...
    return render(request, 'dashboard/blog/category_detail.html', context)
...
def tag_detail(request, slug):
    ...
    return render(request, 'dashboard/blog/tag_detail.html', context)
